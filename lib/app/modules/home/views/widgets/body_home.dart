...
import 'package:onelife_app/app/modules/home/controllers/home_controller.dart';
...
class BodyHome extends GetView<HomeController> {
  ...
  Widget build(BuildContext context) {
    return SlidingUpPanel(
      minHeight: controller.me.value.id?.isNotEmpty ?? false
          ? Get.height - 560 - Get.bottomBarHeight
          : 0,
      maxHeight:
